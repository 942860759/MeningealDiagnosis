...
def cbam_block_channel_first(inputs, reduction_ratio=16, reuse=None, scope='CBAM_Block_Channel_First'):
    with tf.variable_scope(scope, reuse=reuse):
        ...
        spatial_attention = spatial_attention_module(channel_attention, kernel_size=7, reuse=None,
...
def cbam_block_spatial_first(inputs, reduction_ratio=16, reuse=None, scope='CBAM_Block_Spatial_First'):
    with tf.variable_scope(scope, reuse=reuse):
        ...
        channel_attention = channel_attention_module(spatial_attention, reduction_ratio, reuse=None,
                                                     scope='channel_attention')
